...
function draw() {
  ...
  if (estado === 0) {
    ...
    subirImag(imag, 1, 0, 0, LEFT);
    fondoTexto(0, 360, width, 125,textos[1], 35, 375, 600);
    crearBotones(5, 235, 100, 50, "Volver", 28, 265);
    crearBotones(width-105, 235, 100, 50, "Siguiente", width-90, 265);

    //imagen 2
  } else if (estado=== 2) {
    subirImag(imag, 2, 0, 0, LEFT);
    fondoTexto(0, 360, width, 125,textos[2], 25, 368, 600);
    crearBotones(100, 300, 100, 50, "    Ver\nventanilla", 115, 320);
    crearBotones(width-200, 300, 100, 50, "   Sigue\ntrabajando", width-190, 320);

    //imagen 3
  } else if (estado=== 3) {
    subirImag(imag, 3, 0, 0,LEFT);
    fondoTexto(0, 360, width, 125,textos[3], 25, 400, 600);
    crearBotones(285, 300, 100, 50, "Reiniciar", 300, 330);

    //imagen 4
  } else if (estado=== 4) {
    subirImag(imag, 4, 0, 0,LEFT);
    fondoTexto(0, 360, width, 125,textos[4], 25, 375, 600);
    crearBotones(285, 300, 100, 50, "Siguiente", 300, 330);

    //imagen 5
  } else if (estado===5) {
    subirImag(imag, 5, 0, 0, LEFT);
    fondoTexto(0, 360, width, 125,textos[5], 25, 385, 600);
    ...
    subirImag(imag, 6, 0, 0, LEFT);
    fondoTexto(0, 360, width, 125,textos[6], 25, 390, 600);
    crearBotones(285, 300, 100, 50, "Siguiente", 300, 330);

    //imagen 7
  } else if (estado===7) {
    subirImag(imag, 7, 0, 0,LEFT);
    fondoTexto(0, 360, width, 125,textos[7], 25, 368, 600);
    crearBotones(285, 300, 100, 50, "Reiniciar", 300, 330);

    //imagen8
  } else if (estado===8) {
    subirImag(imag, 8, 0, 0, LEFT);
    fondoTexto(0, 360, width, 125,textos[8], 25, 375, 600);
    crearBotones(100, 300, 100, 50, "Volver", 125, 330);
    crearBotones(width-200, 300, 100, 50, "Siguiente", width-190, 330);

    //imagen 9
  } else if (estado===9) {
    subirImag(imag, 9, 0, 0, LEFT);
    fondoTexto(0, 360, width, 125,textos[9], 25, 368, 600);
    crearBotones(100, 300, 100, 50, "Volver", 125, 330);
    crearBotones(width-200, 300, 100, 50, "Siguiente", width-190, 330);

    //imagen 10
  } else if (estado===10) {
    subirImag(imag, 10, 0, 0, LEFT);
    fondoTexto(0, 360, width, 125,textos[10], 25, 385, 600);
    crearBotones(285, 300, 100, 50, "Juego", 310, 330);

    //imagen 11
  } else if (estado===11) {
    subirImag(imag, 11, 0, 0, LEFT);
    fondoTexto(0, 360, width, 125,textos[12], 25, 385, 600);
    crearBotones(100, 300, 100, 50, "Reiniciar \n  juego", 115, 320);
    crearBotones(width-200, 300, 100, 50, "Fin", width-165, 330);

    //imagen 12
  } else if (estado===12) {
    subirImag(imag, 12, 0, 0, LEFT);
    fondoTexto(0, 360, width, 125,textos[11], 25, 368, 600);
    crearBotones(100, 300, 100, 50, "Reiniciar \n  juego", 115, 320);
    crearBotones(width-200, 300, 100, 50, "Fin", width-165, 330);
